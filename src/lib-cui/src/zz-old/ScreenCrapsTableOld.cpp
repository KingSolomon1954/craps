...
ScreenCrapsTable::drawBorders()
{
    ...
    {
        eraseJunctionsOnePlayer();
        drawJunctionsAllPlayers();
    }
    else
    {
        eraseJunctionsAllPlayers();
        drawJunctionsOnePlayer();
    }
...
//----------------------------------------------------------------
//
// Fix up junctions for outer border of all players view
//
void
ScreenCrapsTable::drawJunctionsAllPlayers()
{
    using L = LayoutCrapsScreen;;
...
//----------------------------------------------------------------
//
// Restores player area junctions to a smooth square
//
void
ScreenCrapsTable::eraseJunctionsAllPlayers()
{
    using L = LayoutCrapsScreen;
    using A = LayoutAllPlayers;
...
//----------------------------------------------------------------
//
// Fix up junctions for outer border of one player view
//
void
ScreenCrapsTable::drawJunctionsOnePlayer()
{
    using L = LayoutCrapsScreen;
...
//
void
ScreenCrapsTable::eraseJunctionsOnePlayer()
{
    using L = LayoutCrapsScreen;
    using O = LayoutOnePlayer;
...
//
void
ScreenCrapsTable::cyclePlayerArea()
{
    if (playerArea_ == PlayerArea::AllPlayers)
    {
